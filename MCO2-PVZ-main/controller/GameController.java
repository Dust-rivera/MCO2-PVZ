...
public class GameController {
        ...
        if (drag != null) {
            ...
            if (board != null && view != null) {
                ...
                if (cell != null && !board.getTile(indices[0], indices[1]).isPlantOccupied()) {
                    ...
                    Point cellPosCherry = SwingUtilities.convertPoint(cell.getParent(), cell.getLocation(), view.getLayers());
                    ...
                    Point cellPosPow = SwingUtilities.convertPoint(cell.getParent(), cell.getLocation(), view.getLayers());
    ...
    private void placePlant(int[] indices, Plant p, JPanel cell) {
        ...
        if (p instanceof Sunflower) {
            ...
            ImageIcon originaSunflowerIcon = (ImageIcon) sunflower.getIcon();
            sunflower.setIcon(getTransparentIcon(originaSunflowerIcon, 0.4f));
            Timer recharge = new Timer(500, new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    sunflowerCD -= 500;
                    if (sunflowerCD <= 0) {
                        sunflower.setIcon(originaSunflowerIcon);
